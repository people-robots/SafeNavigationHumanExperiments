...
class SFMNavigationAlgorithm(AbstractNavigationAlgorithm):
	...
	def __init__(self, sensors, target, cmdargs):
		...
		self._d = 0.4
		self._l = 0.59
		self._alpha = 3.5#0.06
		self._gamma = 1.0#0.02
		self._delta = 1.0#0.02
	...
	def select_next_action(self):
		...
		v_0 = v_0*0.15/math.sqrt(np.sum(np.power(v_0,2)))
		if self.count == 0:
		...
		force = force*0.15/force_norm if force_norm>0.15 else force
